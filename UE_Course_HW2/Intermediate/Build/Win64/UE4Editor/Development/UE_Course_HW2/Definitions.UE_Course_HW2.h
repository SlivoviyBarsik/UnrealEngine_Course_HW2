...
#define UE_PROJECT_NAME UE_Course_HW2
#define UE_TARGET_NAME UE_Course_HW2Editor
#define UE_MODULE_NAME "UE_Course_HW2"
...
#define UE_COURSE_HW2_API DLLEXPORT
